...
#ifndef NODE_H
#define NODE_H
// The node class has the variables used in the methods from other classes
// and a default constructor and an overloaded constructor.
template <class T>
class Node {
...
public:
	...
	// The default constructor setslink to nullptr.
	// The overloaded constructor sets data to din and link to nullptr.
	Node(T din) :data(din), link(nullptr) {}
